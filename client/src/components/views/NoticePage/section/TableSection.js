...
import {Table, TableHead, TableBody, TableRow, TableCell, Box, Typography} from '@material-ui/core';
        ...
        <Box>
            {
                ...
                :
                    post.length === 0 ?
                        <Box className={classes.noticeDiv}><Typography variant='h3'>게시물이 없습니다.</Typography></Box>
                    :
